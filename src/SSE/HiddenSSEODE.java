...
public class HiddenSSEODE implements FirstOrderDifferentialEquations {
	...
	private HiddenInstantaneousRateMatrix q; // ctor arg
	 ...
	 */
	public HiddenSSEODE(Double[] mu, HiddenInstantaneousRateMatrix q, double rate, boolean incorporateCladogenesis) {
		this.mu = mu;
		this.q = q;
		this.rate = rate;

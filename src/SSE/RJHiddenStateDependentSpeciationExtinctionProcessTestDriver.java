...
public class RJHiddenStateDependentSpeciationExtinctionProcessTestDriver {
	...
	public static void main(String[] args) {
		...
		hirm.initByName("numberOfStates", 2, "numberOfHiddenStates", 2, "flatQMatrix", flatQMatrixString, "disallowDoubleTransitions", disallowDoubleTransitions, "hiddenObsStateMapper", stateMapper, "symmetrifyAcrossDiagonal", symmetrifyAcrossDiagonal); 
		System.out.println("\nFull Q Matrix");
		hirm.printMatrix();
		System.out.println();
		...
		masqueradeBall.initByName("modelMask", modelMask1, "hiddenInstantaneousRateMatrix", hirm, "lambdaMuAssigner", lambdaMuAssigner);

...
public class QuaSSEDimensionsAndFunctionsTest {
    ...
    public void testLogistic() {
        ...
        lfn.setYSize(nUsefulBins); // will be done by QuaSSEDistribution
        Double[] lfnOut = lfn.getMacroParams(xRuler);
    ...
    public void testConstant() {
        ...
        cfn.setYSize(nUsefulBins); // will be done by QuaSSEDistribution
        Double[] cfnOut = cfn.getMacroParams(xRuler);

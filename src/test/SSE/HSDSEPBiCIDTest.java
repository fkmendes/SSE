...
public class HSDSEPBiCIDTest {
	...
	public void setUp() throws Exception {
		...
		lambdaMuAssigner.initByName("totalNumberOfStates", 4, "nDistinctLambdas", 2, "nDistinctMus", 2, "lambdasToStates", lambdasToStatesString, "lambda", lambda, "musToStates", musToStatesString, "mu", mu, "pi", pi);

...
public class HSDSEPMuHiSSETest2 {
	...
	public void setUp() throws Exception {
		...
		lambdaMuAssigner.initByName("totalNumberOfStates", 6, "nDistinctLambdas", 6, "nDistinctMus", 6, "lambdasToStates", lambdasToStatesString, "lambda", lambda, "musToStates", musToStatesString, "mu", mu, "pi", pi);

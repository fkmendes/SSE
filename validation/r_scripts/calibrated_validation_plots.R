...
param.labels <- c(expression(paste("Simulated ", lambda[0])),expression(paste("Simulated ",lambda[1])),expression(paste("Simulated ",mu[0])),expression(paste("Simulated ",mu[1])),expression(paste("Simulated ",q[0][1])),expression(paste("Simulated ",q[1][0])))

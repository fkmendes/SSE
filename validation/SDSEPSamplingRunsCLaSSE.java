...
public class SDSEPSamplingRunsCLaSSE {
	...
	public void runExperiment(String treeStr, String spAttr, String[] spNames, String expName,
		...
		TestHelper.prepareAndWriteToCSV(posteriorStoc1D, expName + "-stoc", sdsep);
		TestHelper.prepareAndWriteToCSV(posteriorJoint1D,  expName + "-joint", sdsep);
	}
	...
	public void sampleSmall() throws Exception {
	...
	public void sampleBig() throws Exception {
		...
		runExperiment(treeStr, spAttr, spNames, "CLaSSELarge", 50);
	}
	...
	public void runUserInput(String testFile, String expName) throws Exception {
		...
		runExperiment(treeStr, spAttr, spNames, "beast_results/" + expName, 50);
	}

	public static void main(String[] args) throws Exception {
		SDSEPSamplingRunsCLaSSE runs = new SDSEPSamplingRunsCLaSSE();
//		runs.sampleSmall();
//		runs.sampleBig();
		runs.runUserInput("data/test/test21", "user_input_classe");
	}
}
